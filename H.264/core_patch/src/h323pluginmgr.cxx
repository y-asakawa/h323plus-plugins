...
PBoolean H323PluginVideoCodec::Read(BYTE * /*buffer*/, unsigned & length, RTP_DataFrame & dst)
{
    ...
    // outputDataSize is for the encoded payload size.
    // Do not overwrite bytesPerFrame (raw YUV size), or capture will fail.
                                             ...
                                             unsigned & written, H323_RTPInformation & rtp)
{
  ...
  // outputDataSize is for encoded payload buffering only.
